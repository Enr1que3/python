...
r1.grid(column=0,row=0,sticky=tkinter.W)

r2=tkinter.Radiobutton(ventana,text='Español',value=2,variable=selected)
r2.grid(column=0,row=1,sticky=tkinter.W)


r3=tkinter.Radiobutton(ventana,text='Portugues',value=1,variable=selected)
...
r4.grid(column=0,row=3,sticky=tkinter.W)

bReset=tkinter.Button(ventana,text='Resetar', width=10, command=restart)
bReset.grid(column=0,row=4,sticky=tkinter.W)
